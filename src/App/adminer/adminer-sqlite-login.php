<?php
    ...
    define('SQLiteCredentials', 'admin:12345'); // Specify credentials '$user:$password' or null to skip verification
...
//    define('SQLiteDir', SQLiteBaseDir.'/sqlite'); // sqlite folder
    ...
    define('SQLiteBaseDir', ADMPATH);
    define('SQLiteDir', SQLITE.'sqlite');
