...
class MethodApi
{
	...
	public function __construct($class, $method)
	{
		...
		list($this->description, $tags) = DocBlock::parse($comment);

		if ($file = $this->class->getFileName())
		{
			$this->source = DocBlock::source($file, $this->method->getStartLine(), $this->method->getEndLine());
		}
		...
		if (isset($tags['param']))
		{
			...
			{
				$param = new MethodParamApi(array($this->method->class, $this->method->name),$i);
